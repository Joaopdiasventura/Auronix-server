...
| Cookie settings | `HttpOnly`, `Secure`, `SameSite=None`, path `/` | Browser-based non-HTTPS environments may need trusted localhost or TLS termination |
...
- Response sets `Set-Cookie: auth_cookie=...; HttpOnly; Secure; SameSite=None; Path=/`
