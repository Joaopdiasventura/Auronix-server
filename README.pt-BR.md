...
| Configuração de cookie | `HttpOnly`, `Secure`, `SameSite=None`, path `/` | Ambientes de navegador sem HTTPS podem exigir localhost confiável ou terminação TLS |
...
- A resposta define `Set-Cookie: auth_cookie=...; HttpOnly; Secure; SameSite=None; Path=/`
